/**
 * VIXUAL V1-001 — Project Approve Route
 *
 * POST /api/v1/projects/:id/approve — Admin approves project for publication
 */
...
export async function POST(
  ...
  try {
    ...
    try {
      ...
      const note = body?.moderationNote
    ...
    const project = await projectService.approveProject(id, ctx, moderationNote)
